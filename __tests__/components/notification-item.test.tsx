...
describe("NotificationItem", () => {
  ...
  it("renders title, body, timestamp, and priority badge", () => {
    ...
    expect(getByText("Info")).toBeTruthy(); // From PriorityBadge
  ...
  it("displays correct priority badge for critical", () => {
    const { getByText } = render(
      <NotificationItem notification={{ ...mockNotification, priority: "critical" }} />
    );
  ...
  it("calls onPress when tapped", () => {
    ...
    const { getByTestId } = render(
      <NotificationItem notification={mockNotification} onPress={onPressMock} />
    );
